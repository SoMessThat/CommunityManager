                    ...
                    if(range){
                        ...
                        if(selVal.length == 1 && that.dlen < 7){
                        	layui.use(['jquery','layer'], function() {
                        		var $ = layui.jquery,
                        		layer = layui.layer;
                        		layer.msg(opts.language.name == "cn" ? "未选结束日期" : "Please select the end date",{ time: 1000 });
                        	});
                        	return;
                        	...
                        	layui.use(['jquery','layer'], function() {
                        		var $ = layui.jquery,
                        		layer = layui.layer;
                        		layer.msg(opts.language.name == "cn" ? "结束时间必须大于开始时间" : "The end time must be greater than the start time",{ time: 1000 });
                        	});
                        	return;
                        } 
                    }else{
